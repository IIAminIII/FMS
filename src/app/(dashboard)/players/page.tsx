...
export default function PlayersPage() {
  const { data, saveEntity, canManage } = useFootball();
  ...
  return <><PageHeader eyebrow="The squad" title="Players" description="Manage the friends who play, their usual fee, and their complete payment position." actions={canManage ? <PlayerDialog trigger={<Button><Plus />Add player</Button>} /> : undefined} />
