...
import { PaymentClaimReview } from "@/components/payment-claim-review";
...
export default function ContributionsPage() {
  ...
  return <><PageHeader eyebrow="Money in" title="Contributions" description="Every payment received from players and sponsors—never mixed with match expenses." actions={canManage ? <ContributionDialog trigger={<Button><Plus />Record contribution</Button>} /> : undefined} />
    <PaymentClaimReview />
