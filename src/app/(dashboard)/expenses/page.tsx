...
export default function ExpensesPage() {
  ...
  return <><PageHeader eyebrow="Money out" title="Expenses" description="A separate, transparent list of turf fees and everything else the group paid for." actions={<ExpenseDialog trigger={<Button><Plus />Record expense</Button>} />} />
