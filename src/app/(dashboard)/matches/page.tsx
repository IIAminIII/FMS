...
export default function MatchesPage() {
  ...
  return <><PageHeader eyebrow="Every Saturday" title="Matches" description="Plan the next kick-off and keep a clean weekly record of attendance, money, and turf costs." actions={canManage ? <MatchDialog trigger={<Button><Plus />Plan match</Button>} /> : undefined} />
